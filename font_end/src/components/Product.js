...
const Product = ({product}) => {
  ...
  return <div>
    ...
    {/*  buttons*/}
      <div className='absolute top-6 right-11 group-hover:right-5 bg-red-500/40 p-2 flex-col items-center justify-center gap-y-2 opacity-0 group-hover:opacity-100 transition-all
      duration-300'>
        <button>
